...
const faq = [
  ...
  },
  {
    ...
    a: "Le boost met votre formation en avant pendant 7 jours pour plus de visibilité. Utilisez le bouton « Booster 7 jours » sur la fiche de votre formation.",
  },
];
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur">
          ...
          <Link
            href="/dashboard"
            className="mt-4 inline-flex items-center gap-2 rounded-xl bg-accent px-4 py-2.5 font-semibold text-white transition hover:opacity-90"
          >
            Voir le guide
            <span>→</span>
          </Link>
